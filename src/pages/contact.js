      ...
      <div class="grid lg:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-4xl max-lg:max-w-2xl bg-(--foreground) [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
            ...
            <ul class="mt-4">
              <li class="flex items-center">
                ...
                <Link href="javascript:void(0)" class="text-sm ml-4">
                  ...
                  <span class="text-blue-400 font-medium">yasminsofia.school@gmail.com</span>
                   <small class="block text-slate-200">Telefone</small>
                  <span class="text-blue-400 font-medium">(11) 99999999</span>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <form class="space-y-4">
          <input type='text' placeholder='Nome'
            class="w-full text-slate-200 rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-0 focus:border-blue-500" />
          <input type='email' placeholder='Email'
            class="w-full text-slate-200 rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-0 focus:border-blue-500" />
          <input type='text' placeholder='Assunto'
            class="w-full text-slate-200 rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-0 focus:border-blue-500" />
          <textarea placeholder='Mensagem' rows="6"
            class="w-full text-slate-200 rounded-md px-4 border border-gray-300 text-sm pt-2.5 outline-0 focus:border-blue-500"></textarea>
          <button type='button'
            class="text-white bg-blue-500 hover:bg-blue-700 rounded-md text-sm font-medium px-4 py-2.5 w-full cursor-pointer border-0 mt-2">Enviar mensagem</button>
        </form>
      </div>
    </section>
    <Footer></Footer>
